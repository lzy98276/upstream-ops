...
export type CaptchaProviderType =
  "capsolver" | "2captcha" | "anticaptcha" | "yescaptcha";
...
export type ChannelAPIKeyStatus =
  "active" | "disabled" | "expired" | "quota_exhausted" | "unknown";
...
export type GatewayRateConvertMode =
  "raw" | "multiply_100" | "divide_100" | "custom";
export type GatewayModelsMode = "auto" | "manual" | "hybrid";
export type GatewayServiceTier = "all" | "priority" | "flex";
export type GatewayServiceTierAction =
  "filter" | "passthrough" | "block" | "force_priority";
...
export interface NewAPIAutoGroups {
  groups: string[];
