...
import (
	...
	"github.com/lzy98276/upstream-ops/backend/api"
	...
	"github.com/lzy98276/upstream-ops/backend/logger"
	...
	"github.com/lzy98276/upstream-ops/web"

	// 注册 connector 实现。
	_ "github.com/lzy98276/upstream-ops/backend/connector/newapi"
	_ "github.com/lzy98276/upstream-ops/backend/connector/sub2api"
)
...
func main() {
	...
	syncSvc := syncer.New(channels, rates, cipher, channelSvc, log, syncTargets, syncGroups, upstreamSyncGroups, upstreamSyncAccounts, managedSyncAccounts, syncLogs, gatewaySvc, cfg.Server.BaseURL)
